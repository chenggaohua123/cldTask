...
//			byte[] raw = password.getBytes("utf-8");
	...
	public static void main(String[] args) {
		...
		String tt = AESTools.encrypt(ss, pas);
		System.out.println("密文="+tt);
		String t1 = AESTools.decrypt("fbeA4fn+I/BqrPJm4bXEwQmVrobFF/CZX8OBu3WXau176RsVT9SH27DOZN3pTSOREzCnOxQ0FLCPSim9XeUwEuVaS+vWSQVxttYFTfZc0mDPKtEGmqDP1Uxg+WzP2hyd".getBytes(), pas);
		System.out.println("原文="+t1);
	}
}