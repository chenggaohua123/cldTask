...
<body>
	<div style="margin: 20px; width: 80%;">
		<h2>Dear ${email}:</h2>
		<p>Thanks for choosing BringAllPay as the payment service. <br /> 
		Your transaction was declined by your issuing bank. </p>
		Please contact your bank to ask for online shopping authorization.		</p>
		<p>If you have any question for this, please feel free to contact the seller via CONTACT US page on the shopping website. Thank you.
		<p>
			-------------------------------------------------------------------------------------------------------------------<br />
			Order No.: ${orderNo}<br /> Payment No.: ${tradeNo}<br /> Payment
			Date&amp;Time : ${tradeDateTime}<br /> Amount : ${sourceAmount}
			${currency}<br />Shopping website:${website}
		</p>
		<p>-------------------------------------------------------------------------------------------------------------------
		</p>
		<p>
